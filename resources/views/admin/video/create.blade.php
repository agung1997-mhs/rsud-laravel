                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.video.store') }}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="title" value="{{ old('title') }}" placeholder="Masukkan Judul Video"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="embed" value="{{ old('embed') }}" placeholder="Masukkan Embed YouTube"
