...
<head>
    ...
    <title>Dashboard &mdash; RSUD Kemayoran</title>
    <link rel="shortcut icon" href="{{ asset('assets/img/rsud.png') }}" type="image/x-icon">
    <!-- General CSS Files -->
        ...
        <div class="main-wrapper main-wrapper-1">
                ...
                <ul class="navbar-nav navbar-right">
                    <li class="dropdown">
                        <a href="#" data-toggle="dropdown" 
                            class="nav-link dropdown-toggle nav-link nav-link-user">
                            <img alt="image" src="{{ asset('assets/img/agung.jpg') }}"
            ...
            <div class="main-sidebar sidebar-style-2">
                <aside id="sidebar-wrapper">
                    <div class="sidebar-brand">
                        <img src="{{ asset('assets/img/rsud.png') }}" class="h-100" alt="logo">
                        <a href="{{ route('admin.dashboard.index') }}">RSUD Kemayoran</a>
                    </div>
                    <div class="sidebar-brand sidebar-brand-sm">
                        <a href="{{ route('admin.dashboard.index') }}">RSUD</a>
                    </div>
            ...
            <footer class="main-footer">
                <div class="footer-left">
                    Copyright &copy; 2022 <div class="bullet"></div> RSUD Kemayoran <div class="bullet"></div> All Rights 
                    Reserved.
                </div>
